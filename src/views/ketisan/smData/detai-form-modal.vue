      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="操作人员：" prop="personnelId">
            ...
            <el-input :placeholder="personnelDetail.name" disabled autocomplete="off"  style="width: 300px"  />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="部门：">
            <el-input disabled :placeholder="personnelDetail.department" autocomplete="off"  style="width: 300px" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="联系方式：" >
            <el-input :placeholder="personnelDetail.contact" autocomplete="off" disabled style="width: 300px" />
          </el-form-item>
        </el-col>
