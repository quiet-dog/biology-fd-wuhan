...
import {
  maintenanceManualRes,
  maintenanceManualList,
  renewMaintenanceManualRes,
  renewMaintenanceManual
...
const searchFormParams = reactive<maintenanceManualRes>({
  equipmentName: "",
  equipmentType: ""
});
...
const archiveListFun = async () => {
  ...
  const { data } = await maintenanceManualList(toRaw(searchFormParams)).finally(
    () => {
...
const detailRef = ref();
const openDetailDialog = (row: renewMaintenanceManualRes) => {
