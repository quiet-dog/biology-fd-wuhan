    ...
    >
      ...
      <el-form-item label="学历：">
        <el-select
          ...
          placeholder="请选择学历"
          clearable
          v-model="searchFormParams.education"
        >
      ...
      <el-form-item label="联系方式：">
        <el-input
          v-model="searchFormParams.contact"
          class="!w-[200px]"
          placeholder="请输入联系方式"
          clearable
        />
        ...
        >
          ...
          <template #operation="{ row }">
            <el-button
              ...
              type="primary"
              :size="size"
              @click="openDetailDialog(row, false)"
            >
              查看
            </el-button>
            <el-button
              ...
              type="primary"
              :size="size"
              @click="openDetailDialog(row, true)"
            >
              修改
            </el-button>
          </template>
...
const exportClick = () => {
  ...
  exportPersonnel(
    toRaw({ ...searchFormParams, personnelIds: multipleSelection.value })
  ).then(res => {
