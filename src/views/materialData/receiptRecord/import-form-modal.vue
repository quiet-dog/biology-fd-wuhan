...
import { downloadReceiveTemplate, downloadTemplate } from "@/api/materialData/materialFiles";
...
const upload = reactive({
  ...
  // 上传的地址
  url: `${defaultConfig.baseURL}/manage/receive/excel`
});

const uploadRef = ref();

const downloadTemplateClick = () => {
  downloadReceiveTemplate().then(res => {
    ExportDownload(res, "领用记录导入模板");
  }).catch(err => {
