...
export function editSmDevice(data: UpdateSmDeviceReq) {
  return http.request("put", "/manage/smDevice/" + data.smDeviceId, {
    data
  });
}

export function getSmThreshold(id: number) {
  return http.request<ResponseData<GetSmThresholdRes[]>>(
    "get",
    "/manage/smDevice/getThreshold/" + id
  );
}
